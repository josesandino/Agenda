...
-- Tiempo de generación: 11-10-2018 a las 02:28:41
...
(1, 'admin', 'admin', '$2y$12$YO4f9NNqfS1XFBPuX9O6keWzqDdSwoQzfgNziYd.bzbboWweP5f0i', '0000-00-00 00:00:00', 1),
(11, 'admin1', 'admin', '$2y$12$eDHNyTVVRTrC9FpoVvNFG.DRiPeAAwlw4kgNf8i2hy47xRZpKlija', '0000-00-00 00:00:00', 0),
(12, 'admin2', 'admin', '$2y$12$yrpeqDNzsdrrnPG5t2qf6e2ed0iYzTI0m.dP2q8hqRgxuPCqdK8h.', '0000-00-00 00:00:00', 0);
...
(1, 'Rafael', 'Bautista', 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. ', 'invitado1.jpg'),
(2, 'Shari', 'Herrera', 'Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen.', 'invitado2.jpg'),
(3, 'Gregorio', 'Sanchez', 'No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original.', 'invitado3.jpg'),
(4, 'Susana', 'Rivera', ' Fue popularizado en los 60s con la creación de las hojas \"Letraset\", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.', 'invitado4.jpg'),
(5, 'Harold', 'Garcia', 'Al contrario del pensamiento popular, el texto de Lorem Ipsum no es simplemente texto aleatorio. Tiene sus raices en una pieza cl´sica de la literatura del Latin, que data del año 45 antes de Cristo, haciendo que este adquiera mas de 2000 años de antiguedad. ', 'invitado5.jpg'),
(6, 'Susan', 'Sanchez', 'Richard McClintock, un profesor de Latin de la Universidad de Hampden-Sydney en Virginia, encontró una de las palabras más oscuras de la lengua del latín, \"consecteur\", en un pasaje de Lorem Ipsum, y al seguir leyendo distintos textos del latín, descubrió la fuente indudable. ', 'invitado6.jpg');
